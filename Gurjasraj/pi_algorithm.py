...
def main():
    ...
    output_path = args.output if args.output else "machines/pi_calculator.tm"
    ...
    print(f"  Verified:     {'YES' if verified else 'NO'} (via mpmath)")
    print(f"  TM file:      {output_path}")
    print(f"\n  To run: python simulator.py {output_path} {num_digits} --trace")
